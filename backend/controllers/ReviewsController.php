...
class ReviewsController extends Controller
{
    ...
    {
        $dataProvider =  Reviews::search(Yii::$app->request->queryParams);
    ...
    public function actionCreate()
    {
        ...
        if (isset(Yii::$app->request->queryParams['product_type_id'])) {
            $model->product_type_id = Yii::$app->request->queryParams['product_type_id'];
        }

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['index', 'product_type_id' => $model->product_type_id]);
        } else {
