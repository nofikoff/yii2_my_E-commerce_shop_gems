...
<div class="news-form">
    ...
    <?= $form->field($model, 'anons_ru')->textArea(['class' => 'form-control', 'id' => 'anonscontent','type' => 'text','rows'=> 8]) ?>
    <?= $form->field($model, 'content_ru')->textArea(['class' => 'form-control', 'id' => 'pagecontent','type' => 'text','rows'=> 8,'required' => true]) ?>
